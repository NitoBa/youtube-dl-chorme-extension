...
const VideoContextFromApi = createContext<VideoContextData>(
  {} as VideoContextData,
)

export function VideoProviderFromApi({ children }: { children: ReactNode }) {
...
export const useVideoFromApi = () => {
  const context = useContext(VideoContextFromApi)
  if (!context) {
